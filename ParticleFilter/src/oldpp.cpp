...
void incResampleParticles(Rcpp::NumericMatrix& rParticles,
...
void incInitialiseVariables(Rcpp::NumericMatrix& resampledParticles, Rcpp::NumericVector& initialState){
...
void incPropagateParticles(Rcpp::NumericMatrix& particles,
...
void incWeightParticles(double y,
                     Rcpp::NumericVector& weights,
                     Rcpp::NumericMatrix& particles,
                     Rcpp::NumericVector& params){
...
double incComputeLikelihood(Rcpp::NumericVector& weights){
  int N = weights.size();
...
// [[Rcpp::export(name=incParticleFilterCpp)]]
double incParticleFilter(Rcpp::NumericVector y,
                    Rcpp::NumericVector params,
                    int n_particles,
  ...
  incInitialiseVariables(resampledParticles, initialState);

  for(int t = 0; t < n_obs; t++) {
    incPropagateParticles(particles, resampledParticles, params);
    incWeightParticles(y[t], weights, particles, params);
    incResampleParticles(resampledParticles, particles, weights);
    logLikelihood += incComputeLikelihood(weights);
  }
